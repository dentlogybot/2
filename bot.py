...
import threading
import psutil
token = "MTA3ODA2Nzk1NTEwMDgzMTg1NA.GCrgdq.1ZdjY5BGf_2CsZFaSQdhWf9etv11vPtdUPbYfE"
buyers = [738778643622396005]
admins = [738778643622396005]
ownerList = [738778643622396005]
